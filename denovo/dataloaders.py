...
sys.path.append("..")
from dataprocessing.datasets import AnnotatedSpectrumDataset, SpectrumDataset
...
def prepare_batch(
    ...
    idxs: torch.Tensor of shape (batch_size, 1)
        The indices of the PSMs in the dataset
    """
    spectra, precursor_mzs, precursor_charges, spectrum_ids, idxs = list(zip(*batch))
    ...
    return spectra, precursors, np.asarray(spectrum_ids), torch.tensor(idxs)
